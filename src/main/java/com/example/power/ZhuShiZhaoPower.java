...
public class ZhuShiZhaoPower extends AbstractPower {
    public static final String POWER_ID = ModHelper.MakePath(ZhuShiZhaoPower.class.getSimpleName());
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public ZhuShiZhaoPower(AbstractCreature owner) {
        this.ID = POWER_ID;
