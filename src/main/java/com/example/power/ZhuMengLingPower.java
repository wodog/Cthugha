...
public class ZhuMengLingPower extends AbstractPower {
    public static final String POWER_ID = ModHelper.MakePath(ZhuMengLingPower.class.getSimpleName());
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public ZhuMengLingPower(AbstractCreature owner, int amount) {
        this.ID = POWER_ID;
