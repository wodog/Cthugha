...
import com.example.power.XinShangWuMingHuoPower;
...
public class XinShangWuMingHuo extends CustomCard {
    ...
    private static final String IMG_PATH = "cthughaResources/img/card/026.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new XinShangWuMingHuoPower(p, 2)));
    }
