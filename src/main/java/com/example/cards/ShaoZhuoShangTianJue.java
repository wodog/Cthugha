...
public class ShaoZhuoShangTianJue extends CustomCard {

    public static final String ID = ModHelper.MakePath(ShaoZhuoShangTianJue.class.getSimpleName());
